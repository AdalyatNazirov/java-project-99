...
RUN curl -o sentry-opentelemetry-agent.jar https://repo1.maven.org/maven2/io/sentry/sentry-opentelemetry-agent/8.14.0/sentry-opentelemetry-agent-8.14.0.jar
